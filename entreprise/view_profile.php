...
// Vérifier si l'utilisateur est connecté et est admin ou entreprise
if (!isset($_SESSION['user_id']) || ($_SESSION['user_type'] !== 'admin' && $_SESSION['user_type'] !== 'entreprise')) {
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <div class="text-end mb-4">
                        <a href="../admin/generate_pdf.php?id=<?php echo $id; ?>" class="btn btn-primary">
                            <i class="bi bi-download"></i> Télécharger le profil
                        </a>
                    </div>
            <div class="row justify-content-center">
                <div class="col-md-4">
